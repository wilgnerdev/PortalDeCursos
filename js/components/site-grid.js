const cursos = [
    { titulo: "Assistente Admnistrativo", img: "foto-adm.jpg", desc: "Gestão de documentos, atendimento e rotinas administrativas empresariais." },
    ...
    { titulo: "Auxiliar de Desenvolvimento Web (Programação)", img: "prog.jpg", desc: "Criação e arquitetura de softwares e sites modernos." },
    ...
    { titulo: "Suporte em T.I", img: "aprendizagem-profissional-suporte-ti.jpg", desc: "Manutenção, reparo e diagnóstico de computadores e instalação de sistemas operacionais." },
    ...
    { titulo: "Mecânica Automotiva", img: "aprendizagem-profissional-mecanica.jpg", desc: "Manutenção, reparo e diagnóstico de veículos automotores." },
